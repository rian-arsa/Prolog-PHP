...
<body>
    ...
    <div class="container">
        <div class="modul1">
            ...
            <h3 style="text-align: center">Pengenalan Prolog</h3>
        </div>
        <div style="margin: 100px" class="jawaban">

        </div>
        <p>Dalam modul ini, kami mengimplementasikan modul 1 dengan proses ramalan pencarian jodoh</p>
        <div style="margin: 100px" class="jawaban">

        </div>
        <form action="jawaban1.php" method="POST">
            <div class="form-group">
                <label for="exampleInputEmail1">Masukkan Nama Depan</label>
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama depan" name="nama">
            </div>
