...
function modul6($psy, $psj, $psk, $psl, $psm)
{
    // modul2
    $file = fopen("modul6.pl", "a+") or die("Unable to open file!");
...
echo modul6($modul6a, $modul6b, $modul6c, $modul6d, $modul6e);
...
if ($outt == 1) {
    ...
    $out = "Iphone SE dengan harga Rp. 6.000.000";
}
?>
...
<body>
    ...
    <div class="container">
        ...
        <h2>Hasilnya kami merekomendasikan : <span style="color: coral"><?php echo $out ?></span></h2>
    </div>
    <div class="container">
        <div style="margin: 100px" class="jawaban">
