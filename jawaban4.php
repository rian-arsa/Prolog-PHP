...
$modul3a = $_POST['pertama'];
$modul3b = $_POST['kedua'];


function modul4($psy, $psj)
{
    // modul2
    $file = fopen("modul4.pl", "a+") or die("Unable to open file!");
...
echo modul4($modul3a, $modul3b);

$out = `swipl -s modul4.pl -g "program." -t halt. `;
...
<body>
    ...
    <div class="container">
        ...
        <h2>Hasil operasi logikanya adalah : <span style="color: coral"><?php echo $out ?></span></h2>
    </div>
    <div class="container">
        <div style="margin: 100px" class="jawaban">
