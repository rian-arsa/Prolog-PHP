...
{
    // modul2
    $file = fopen("modul2.pl", "a+") or die("Unable to open file!");

    if (!empty($psy)) {

        //modul2
        fprintf($file, "findLast(X, $psy).\n");
    }
...
$out = `swipl -s modul2.pl -g "hasil." -t halt. `;
...
<body>
    ...
    <div class="container">
        ...
        <h2>List terakhir adalah : <span style="color: coral"><?php echo $out ?></span></h2>
    </div>
    <div class="container">
        <div style="margin: 100px" class="jawaban">
