...
<body>
    ...
    <div class="container">
        <div class="modul1">
            <h1 style="text-align: center">Modul 4 </h1>
            <h3 style="text-align: center">Operasi Logika</h3>
        </div>
        <div style="margin: 100px" class="jawaban">

        </div>
        <p>Dalam modul ini, kami mengimplementasikan modul 4 untuk Mencari operasi logika AND</p>
        <div style="margin: 100px" class="jawaban">

        </div>

        <form action="jawaban4.php" method="POST">
            <label for="">Pilih option pertama</label><br>
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" id="customRadio" name="pertama" value="1">
                <label class="custom-control-label" for="customRadio">TRUE</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
            ...
            <label for="">Pilih option kedua</label><br>
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" id="customRadio3" name="kedua" value="1">
                <label class="custom-control-label" for="customRadio3">TRUE</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" id="customRadio4" name="kedua" value="2">
                <label class="custom-control-label" for="customRadio4">FALSE</label>
            </div><br><br><br>
