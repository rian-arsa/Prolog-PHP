...
$modul3a = $_POST['angka1'];
$modul3b = $_POST['angka2'];


function modul3($psy, $psj)
{
    // modul2
    $file = fopen("modul3.pl", "a+") or die("Unable to open file!");
...
echo modul3($modul3a, $modul3b);

$out = `swipl -s modul3.pl -g "program." -t halt. `;
...
<body>
    ...
    <div class="container">
        ...
        <h2>Hasil perkalian nya adalah : <span style="color: coral"><?php echo $out ?></span></h2>
    </div>
    <div class="container">
        <div style="margin: 100px" class="jawaban">
